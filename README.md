...
### Text guide
1. Install Honey Select 2 to a directory with no Japanese characters in its path (e.g. D:\Games\HS2, if you're installing HoneySelect 2 on Steam you shouldn't have to worry about this)
